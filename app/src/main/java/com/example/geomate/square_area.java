...
public class square_area extends Fragment {

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        View view = inflater.inflate(R.layout.fragment_square_area, container, false);
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(side_str)) {
                    ...
                    if (side_value <= 0) {
                        ...
                        double area = calculateSquareArea(side_value);
    ...
    private double calculateSquareArea(double sideLength) {
