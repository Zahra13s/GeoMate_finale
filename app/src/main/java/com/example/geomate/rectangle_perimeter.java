...
public class rectangle_perimeter extends Fragment {
    @Override
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(length_str)) {
                    ...
                    if (length_value <= 0 || width_value <= 0) {
                        ...
                        double perimeter = calculateRectanglePerimeter(length_value, width_value);
    ...
    private double calculateRectanglePerimeter(double lengthLength, double widthLength) {
