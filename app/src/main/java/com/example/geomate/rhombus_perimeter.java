...
public class rhombus_perimeter extends Fragment {

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        View view = inflater.inflate(R.layout.fragment_rhombus_perimeter, container, false);
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(side_str)) {
                    ...
                    if (side_value <= 0) {
                        ...
                        double perimeter = calculateRhombusPerimeter(side_value);
    ...
    private double calculateRhombusPerimeter(double sideLength) {
        return 4 * sideLength;
    }
}
